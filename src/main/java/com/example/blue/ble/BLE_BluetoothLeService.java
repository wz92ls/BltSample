 ...
 */
public class BLE_BluetoothLeService extends Service {
    private final static String TAG = BLE_BluetoothLeService.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        BLE_BluetoothLeService getService() {
            return BLE_BluetoothLeService.this;
        }
    }
...
*/
    ...
    public void disconnect() {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.d(TAG, "close-BluetoothAdapter not initialized");
            return;
        }
