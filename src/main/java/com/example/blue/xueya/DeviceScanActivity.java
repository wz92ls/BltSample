 ...
 */
package com.example.blue.xueya;
...
public class DeviceScanActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    private Button button,button_time,voiceSet,start_wbp,user_send,scan_button,stop_button;
...
//
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xueya_main_layout);
        ...
        scan_button=$(R.id.scan);
        stop_button=$(R.id.stop);
        button=$(R.id.sycn);
...
//            mBLE.scanLeDevice(true);//start to scan
    ...
    private void init() {
        ...
        Log.e("show the currentapiVersion",""+currentapiVersion);
...
//                    Log.e("datas", "看看这个值是什么" + "" + datas);
                if (config.getConnectPreipheralOpsition().getModel().equals(Constant.WT2)) {
                    resolveWt2.calculateData_WT2(datas,mBLE,DeviceScanActivity.this,config);//to  resolve the data from wt2
                ...
                {
                    resolvewt1.calculateData_WT1(datas,mBLE,DeviceScanActivity.this,config);//resolve data from wt1
                }
            } else {
                final byte[] data= characteristic.getValue();
